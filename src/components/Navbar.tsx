    ...
    <nav className="fixed top-0 left-0 right-0 z-40 border-b border-white/10 bg-[rgba(9,9,11,0.85)] backdrop-blur-xl">
      <div className="flex items-center justify-between px-4 sm:px-6 md:px-10 lg:px-16 py-3 sm:py-4 md:py-5">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="relative h-7 w-7 sm:h-8 sm:w-8 overflow-hidden rounded-lg bg-white p-[3px] transition-transform duration-300 group-hover:scale-105">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="md:hidden flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-white/20" aria-label="Menu">
