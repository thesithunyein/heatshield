          ...
          <div className="flex flex-col md:flex-row md:gap-16 lg:gap-24">
            ...
            <div className="flex-1">
              {[
                ...
                { q: "Which cities does HeatShield support?", a: "HeatShield works with any location in the United States using FortyGuard's Temperature API. We currently support 10 major US cities including Phoenix, Las Vegas, Houston, Miami, Los Angeles, Dallas, San Antonio, Sacramento, Atlanta, and more." },
            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-2">
                  ...
                  <a href="https://x.com/heatshield_app" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/15 flex items-center justify-center text-white/50 hover:border-white/40 hover:text-white transition-all" aria-label="X">
